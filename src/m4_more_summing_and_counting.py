...
def run_test_count_cosines_from():
    ...
    # ------------------------------------------------------------------
    expected = 3
    answer = count_cosines_from(-2, 3, 0.18)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)


    expected = 1
    answer = count_cosines_from(1, 4, .1)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 1
    answer = count_cosines_from(7, 10, 0.5)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(15, 19, 0.3)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 4
    answer = count_cosines_from(8, 14, 0)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.3461773306  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(15,20)
